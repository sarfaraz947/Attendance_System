...
<html lang = "eng">
	<head>
		<title>NARULA INSTITUTE OF TECHNOLGY Attendance Management System</title>
		<meta charset = "utf-8" />
	...
	<body>
		<nav class = "navbar navbar-inverse navbar-fixed-top" style="background-color: orange; color: darkblue;">
		...
		<div class = "navbar navbar-fixed-bottom" style="background-color: blue; color: white;">
			<div class = "container-fluid">
				<center><label>&copy; NARULA INSTIUTE OF TECHNOGY Attendance Management System 2021</label></center>

...
<html lang = "eng">
	<head>
		<title>NARULA INSTITUE OF TECHNOLOGY Attendance Management System</title>
		<meta charset = "utf-8" />
	...
	<body>
		<nav class = "navbar navbar-inverse navbar-fixed-top" style="background-color:lightseagreen; color: darkblue;">
			<div class = "container-fluid">
				<div class = "navbar-header">
					<img src = "images/n.png" width = "50px" height = "50px"/>
		...
		<div class = "navbar navbar-fixed-bottom" style="background-color: orangered; color: darkblue;">
			<div class = "container-fluid">
				<center><label>&copy;NARULA INSTITUE OF TECHNOLOGY Attendance Management System 2021</label></center>

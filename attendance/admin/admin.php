...
<html lang = "eng">
	<head>
		<title>NARULA INSTITUTE OF YTECHNOGY Attendance Management System</title>
		<meta charset = "utf-8" />
	...
	<body>
		<nav class = "navbar navbar-inverse navbar-fixed-top" style="background-color: lightseagreen; color: darkblue;" >
			<div class = "container-fluid">
				<div class = "navbar-header">
					<img src = "images/n.png" width = "100px" height = "80px"/>
		...
		<div class = "navbar navbar-fixed-bottom" style="background-color: lightsalmon; color: darkblue;">
			<div class = "container-fluid">
				<center><label>&copy; NARULA INSTITUTE OF TECGNOLOGY Attendance Management System 2021</label></center>
